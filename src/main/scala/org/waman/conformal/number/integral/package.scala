...
package object integral {
  ...
  implicit class ConformalIntegral[I: Integral](n: I){
    ...
    def gcd(m: I): I = org.waman.conformal.number.integral.gcd(n, m)
    def lcm(m: I): I = org.waman.conformal.number.integral.lcm(n, m)
  }

  //********** Euclidean Division **********
  def modularDivide[I: Integral](dividend: I, divisor: I): (I, I) = {
    require(divisor > 0, s"divisor must be positive: $divisor")
